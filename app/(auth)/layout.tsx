...
export default function Layout({ children }: Readonly<{ children: React.ReactNode }>) {
    return (
        <div className="w-full h-full mx-auto bg-background">
            <div className="min-h-screen flex flex-col">
                <nav className="py-4 px-4 border-b">
                    <div className="max-w-md mx-auto flex justify-between items-center">
                        <Link href="/login" className="text-sm text-muted-foreground hover:text-foreground">➜ Auth/Home Page</Link>
                ...
                <div className="py-4 px-4 border-t">
                    <div className="max-w-md mx-auto space-y-4">
                        ...
                        <div className="flex justify-center space-x-4">
                            <Button className="bg-transparent hover:bg-primary-foreground text-muted-foreground hover:text-foreground" size={"icon"}>
