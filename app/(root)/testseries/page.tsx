    ...
    return (
        <div className="flex flex-col bg-primary/5">
            <div className="flex flex-col mx-auto justify-center items-center gap-2 my-3 md:mt-24">
                <div className="text-base transform scale-y-125 text-destructive font-medium w-11/12 text-center">testseries are undergoing maintenance - due to high traffic</div>
                {
                    data?.map((item, index) => (
